      ...
      >
        <MenuButton
          className={`
            ...
            min-768:shadow-[-1px_0px_0px_0px_hsl(var(--elements))]
            cursor-pointer
        ...
        >
          <div>
            <MenuItem as="div">
              <div
                className="w-full shadow-none min-768:shadow-[-1px_-1px_0_0_hsl(var(--elements))]"
                onClick={(e) => {
                  e.stopPropagation();
                }}
              >
            ...
            <MenuItem as="div">
              <div
                className="w-full shadow-none min-768:shadow-[-1px_-1px_0_0_hsl(var(--elements)),_-1px_1px_0_0_hsl(var(--elements))]"
                onClick={(e) => {
                  e.stopPropagation();
                }}
              >
